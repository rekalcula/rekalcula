...
export async function GET(request: NextRequest) {
  try {
    ...
    // 2. Obtener salidas (facturas)
    // Columnas: total_amount (no total), supplier (no provider), invoice_date
    ...
    // 3. Obtener costos fijos del período
    ...
    // Obtener próximos vencimientos (30 días desde hoy)
    ...
    // Transformar upcomingOutbound para usar 'total' en lugar de 'total_amount'
...
function calculateSummary(
  ...
  // Procesar ventas (entradas) - usa 'total'
  sales.forEach(sale => {
  ...
  // Procesar facturas (salidas) - usa 'total_amount'
  ...
  // Calcular costos fijos mensuales prorrateados
...
function groupByPeriod(
  ...
  // Procesar ventas - usa 'total' y 'sale_date'
  sales.forEach(sale => {
  ...
  // Procesar facturas - usa 'total_amount' y 'invoice_date'
  invoices.forEach(invoice => {
