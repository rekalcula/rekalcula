    ...
    return (
      <div className="flex items-center justify-center min-h-[400px]">
        <div className="flex flex-col items-center gap-3">
          ...
          <p className="text-gray-500">Cargando flujo de caja...</p>
        </div>
      </div>
    );
  }
              ...
              {data?.proximosCobros && data.proximosCobros.length > 0 ? (
                <div className="space-y-2">
                  {data.proximosCobros.slice(0, 3).map((cobro) => (
                    <div key={cobro.id} className="flex items-center justify-between py-2 border-b border-gray-100 last:border-0">
                      <div>
