...
export default function TrialBanner() {
  ...
  if (data.subscription.status === 'trialing') {
    ...
    return (
      <div className={`${bgColor} border rounded-lg px-4 py-3 sm:py-4 mb-6 flex items-center justify-between`}>
  ...
  if (data.subscription.status === 'expired' || data.subscription.status === 'canceled') {
    return (
      <div className="bg-red-50 border border-red-200 rounded-lg px-4 py-3 sm:py-4 mb-6 flex items-center justify-between">
        <div className="flex items-center">
          <span className="mr-3">
