...
export default function TrialBanner() {
  ...
  if (data.subscription.status === 'trialing') {
    ...
    return (
      <div className={`${bgColor} border rounded-lg p-4 mt-4 mb-4 mx-4 sm:mt-0 sm:mb-6 sm:mx-0 flex items-center justify-between`}>
  ...
  if (data.subscription.status === 'expired' || data.subscription.status === 'canceled') {
    return (
      <div className="bg-red-50 border border-red-200 rounded-lg p-4 mt-4 mb-4 mx-4 sm:mt-0 sm:mb-6 sm:mx-0 flex items-center justify-between">
        <div className="flex items-center">
          <span className="mr-3">
