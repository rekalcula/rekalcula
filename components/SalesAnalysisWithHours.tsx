...
import OpportunityAnalysisV4WithHours from '@/components/OpportunityAnalysis_v4_WithHours'
...
export default function SalesAnalysisWithHours() {
  ...
  if (!hoursConfigured) {
    return (
      <div className="space-y-6">
        ...
        <BusinessHoursConfig onSaved={handleHoursSaved} />
  ...
  return (
    <div className="space-y-6">
      ...
      <OpportunityAnalysisV4WithHours />
    </div>
  )
}