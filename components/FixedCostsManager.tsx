                      ...
                      {cost.is_payroll && cost.payroll_data && (
                        <div className="mt-2 text-xs text-gray-500 bg-gray-100 rounded p-2">
                          <div className="grid grid-cols-2 gap-2">
                            <span>Bruto: €{cost.payroll_data.salario_bruto?.toFixed(2)}</span>
                            <span>SS Empresa: €{cost.payroll_data.ss_empresa?.toFixed(2)}</span>
                            <span>Líquido: €{cost.payroll_data.liquido_percibir?.toFixed(2)}</span>
                            <span>IRPF: €{cost.payroll_data.irpf?.toFixed(2)}</span>
                          </div>
                        </div>
                      )}
                    </div>
