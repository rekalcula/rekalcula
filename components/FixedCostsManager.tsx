                      ...
                      {cost.is_payroll && cost.payroll_data && (
                        <div className="mt-3 bg-[#262626] border border-[#404040] rounded-lg p-3">
                          <div className="grid grid-cols-1 sm:grid-cols-4 gap-3">
                            {/* Salario Bruto */}
                            <div className="bg-blue-500/10 border border-blue-500/30 rounded px-3 py-2.5 flex justify-between items-center">
                            ...
                            {/* SS Empresa */}
                            <div className="bg-red-500/10 border border-red-500/30 rounded px-3 py-2.5 flex justify-between items-center">
                            ...
                            {/* Líquido a Percibir */}
                            <div className="bg-green-500/10 border border-green-500/30 rounded px-3 py-2.5 flex justify-between items-center">
                            ...
                            {/* IRPF */}
                            <div className="bg-amber-500/10 border border-amber-500/30 rounded px-3 py-2.5 flex justify-between items-center">
